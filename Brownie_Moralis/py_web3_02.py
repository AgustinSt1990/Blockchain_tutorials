...
if __name__ == '__main__':
    ...
    connection = Moralis('infura_url')
    connection.are_we_connected()
    connection.load_address_binterface(address, abi)
    connection.supply_ERC20()
    connection.balance_ERC20('0xcad5e6F2a297A6428ba0fBE01bb1f402004A1922')
